const LANG = {
    en: {
        ...
        tipLanguageEn: "Switch to English",
        tipLanguageFr: "Switch to French",
        tipTutorialReopen: "Open the tutorial menu",

        tipGameWindow: "Game window",
        tipStatusWindow: "System status window",
        tipShopWindow: "Upgrades window",
        tipACLWindow: "Access Control (ACL) window",
        tipLogWindow: "Traffic log window",

        tipIntegrity: "System integrity (health)",
        tipRevenue: "Revenue generated by safe packets",
        tipUptime: "Time elapsed since startup",
        tipTrafficLoad: "Current traffic intensity",

        tipBandwidth: "Upgrade packets spawn rate",
        tipDPI: "Activate an automatic filtering module",
        tipPatternDb: "Upgrade the DPI module",
        tipLogSorting: "Sort the traffic log by packet type",
        tipHeavyBastion: "Deploy a Heavy Bastion to reduce core integrity damage by 50%",
        tipRepairSystem: "Repair the system to restore integrity",

        tipAllow: "Filter allowed packets in the log",
        tipDrop: "Filter denied packets in the log",
        tipCritical: "Filter critical alerts in the log",

        tipShapeFilters: "Filter packets by shape",
        tipColorFilters: "Filter packets by color",
        tipOriginFilters: "Filter packets by origin",
        tipRotationFilters: "Filter packets by rotation",
        tipSizeFilters: "Filter packets by size",
    },
    ...
    fr: {
        ...
        tipLanguageEn: "Passer à l'anglais",
        tipLanguageFr: "Passer au français",
        tipTutorialReopen: "Ouvrir le menu du tutoriel",

        tipGameWindow: "Fenêtre de jeu",
        tipStatusWindow: "Fenêtre d'état du système",
        tipShopWindow: "Fenêtre des améliorations",
        tipACLWindow: "Fenêtre de contrôle d'accès (ACL)",
        tipLogWindow: "Fenêtre du journal de trafic",

        tipIntegrity: "Intégrité du système (santé)",
        tipRevenue: "Revenus générés par les paquets sûrs",
        tipUptime: "Temps écoulé depuis le démarrage",
        tipTrafficLoad: "Intensité actuelle du trafic",

        tipBandwidth: "Améliore le taux d'apparition des paquets",
        tipDPI: "Active un module de filtrage automatique",
        tipPatternDb: "Améliore le module DPI",
        tipLogSorting: "Trie le journal de trafic par type de paquet",
        tipHeavyBastion: "Déploie un Bastion lourd pour réduire de 50 % les dégâts infligés à l'intégrité du noyau",
        tipRepairSystem: "Répare le système pour restaurer son intégrité",

        tipAllow: "Filtrer les paquets autorisés dans le journal",
        tipDrop: "Filtrer les paquets refusés dans le journal",
        tipCritical: "Filtrer les alertes critiques dans le journal",

        tipShapeFilters: "Filtrer les paquets par forme",
        tipColorFilters: "Filtrer les paquets par couleur",
        tipOriginFilters: "Filtrer les paquets par origine",
        tipRotationFilters: "Filtrer les paquets par rotation",
        tipSizeFilters: "Filtrer les paquets par taille",
    },
};
